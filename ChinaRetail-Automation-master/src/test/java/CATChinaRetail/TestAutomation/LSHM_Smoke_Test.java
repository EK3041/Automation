...
public class LSHM_Smoke_Test {
	...
	@Test
	public void LSHMSmokeTest() throws Exception {
		try {
			ReadExcel.TestCaseName("LSHM");
			...
			ApplicationLog.InfoLog("Below is the data of smoke test for " + "LSHM" + " Dealer.");
			// select the province
			 ...
			 * Payment
			 * 
			 * Reusablefunctions.clickOnSimulatePayment(driver);
			 * 
			 * //click on Success payment Alert Box
			 * Reusablefunctions.ClickOnSuccessAlert(driver);
			 * 
			 */
			...
			if (LoadingOverlayClosed == true) {
				// click on BuyNow button
				Reusablefunctions.ClickBuyNow(wait, driver);
			}
			 ...
			 * // Select one of the payment option LoadingOverlayClosed =
			 * Reusablefunctions.LoadingAnimationComplete(wait); if(LoadingOverlayClosed ==
			 * true ) { Reusablefunctions.selectPaymentOption(wait); }
			 * 
