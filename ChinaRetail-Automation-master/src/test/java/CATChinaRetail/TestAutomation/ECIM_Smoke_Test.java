...
public class ECIM_Smoke_Test {
	...
	@Test
	public void ECIMSmokeTest() throws Exception {
		try {
			ReadExcel.TestCaseName("ECIM");
			...
			ApplicationLog.InfoLog("Below is the data of smoke test for " + "ECIM" + " Dealer.");
			// select the province
