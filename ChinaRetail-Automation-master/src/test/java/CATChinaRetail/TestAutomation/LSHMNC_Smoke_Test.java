...
public class LSHMNC_Smoke_Test {
	...
	@Test
	public void LSHMNCSmokeTest() throws Exception {
		try {
			ReadExcel.TestCaseName("LSHMNC");
			...
			ApplicationLog.InfoLog("Below is the data of smoke test for " + "LSHMNC" + " Dealer.");
			// select the province
